...
from .admin_views import add_result_view, edit_result_view, auto_save_ticket, delete_individual_ticket
from . import views
...
urlpatterns = [
    ...
    path('admin/delete-individual-ticket/', delete_individual_ticket, name='delete_individual_ticket'),
