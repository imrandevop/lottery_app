...
```json
{
  "unique_id": "987fcdeb-51a2-43c1-b789-123456789abc",
  "app_name": "lotto lite"
}
```
...
```json
{
  "unique_id": "456e7890-abcd-12d3-e456-789012345678",
...
- **Device ID:** Shortened UUID (e.g., "123e4567...")
...
|-------|----------|-------------|---------|
| unique_id | Yes | UUID generated by mobile app (device/installation ID) | "123e4567-e89b-12d3-a456-426614174000" |
...
- Device UUID "123abc..." uses Lotto app → Creates record 1
...
### Error: "Invalid data"
- **Cause:** Missing required field or invalid UUID format
- **Solution:** Ensure unique_id is valid UUID and app_name is provided
